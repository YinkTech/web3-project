...
const App = () => {
  return (
    <div className='body'>
      <div className='container-fluid first-section row mx-auto'>
      ...
      <div className='py-5 container-fluid six-section '>
        ...
        <div className='container-fluid justify-content-around p-1 m-0 p-md-4 row '>
          ...
          <button className='buttn btn mt-5' style={{width: '-webkit-fit-content', display: 'block'}}> View All </button>
        </div>
      </div>
      ...
      <div className="footer cursor-pointer container-fluid justify-content-center row my-5">
        <div className='col-md-3'>
          ...
          <div className=" col-md-2">
            <h4 className='fw-bolder my-3'> Useful Links </h4>
          ...
          <div className='col-md-3'>
            <h4 className='fw-bolder my-3'> Newsletter </h4>
      ...
      <div className=" text-center my-2 fw-bolder ">&copy; Copyright by YinkTech. All Rights Reserved.</div>
    </div>
  )
}
